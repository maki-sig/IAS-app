...
export default function DashboardClient({
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      <Sidebar activeTab={activeTab} username={username} onTabChange={setActiveTab} />
      <main className="flex-1 flex flex-col min-w-0 bg-transparent overflow-hidden">
        <header className="px-8 py-6 flex items-center justify-between border-b border-sidebar-border transition-colors duration-300">
          <div>
            <h2 className="text-lg font-light tracking-tight text-foreground capitalize transition-colors duration-300">{activeTab} Management</h2>
          </div>
